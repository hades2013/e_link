...
//_RT_802_11_MAC_ENTRY 根据无线驱动不一样可能不一样，见驱动文件中的oid.h

#if defined (PRODUCT_WR750X_MTC) || defined (PRODUCT_WR300X_MTC) || defined (PRODUCT_L_WR300X_MTC) || defined(PRODUCT_RE7502_MTC)
...
{	
	...
	/*	SHORT		TxPER;	*/					
	/* TX PER over the last second. Percent */
...
//////////
//PRODUCT_WR1203_MTC
typedef struct _RT_802_11_MAC_ENTRY_MT7628 {
	unsigned char ApIdx;
	unsigned char Addr[6];
	unsigned char Aid;
	unsigned char Psm;		/* 0:PWR_ACTIVE, 1:PWR_SAVE */
...
/*	signed short reserved;*/
//#endif /* RTMP_RBUS_SUPPORT */
} RT_802_11_MAC_ENTRY_MT7628, *PRT_802_11_MAC_ENTRY_MT7628;
///////////////////

#define MAX_NUMBER_OF_MAC               120
...
typedef struct _RT_802_11_MAC_TABLE_MT7628 {
	unsigned long            Num;
	RT_802_11_MAC_ENTRY_MT7628      Entry[MAX_NUMBER_OF_MAC]; //MAX_LEN_OF_MAC_TABLE = 32
} RT_802_11_MAC_TABLE_MT7628;
